...
class ColumnOrderHandler {
  ...
  render() {
    return index.h("div", { class: "drag-position-y", hidden: true, ref: (el) => (this.element = el) });
  }
}
...
class ColumnPlugin extends BasePlugin {
  constructor(revogrid, providers) {
    ...
    this.revogrid = revogrid;
    this.providers = providers;
    this.moveFunc = debounce$1.debounce_1((e) => this.doMove(e), 5);
...
const HeaderCellRenderer = ({ data, props }, children) => {
  ...
  return (index.h(ResizableElement, Object.assign({}, cellProps, { onMouseDown: (e) => {
